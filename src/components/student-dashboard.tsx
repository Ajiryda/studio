...
import { uksVisits } from '@/lib/mock-data'; // Assuming you have mock visit data
...
export function StudentDashboard() {
    ...
    useEffect(() => {
        if(user && user.role === 'siswa') {
            const studentVisits = uksVisits.filter(visit => visit.studentId.toString() === user.id);
    ...
    return (
        <div className="space-y-8">
          ...
          <CardHeader>
            ...
            <CardDescription>Hasil skrining kesehatan yang pernah Anda ikuti.</CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
               <TableHeader>
                ...
                <TableBody>
                  {screeningHistory.length > 0 ? screeningHistory.map((entry, index) => (
                    <TableRow key={index}>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Catatan kunjungan Anda ke Unit Kesehatan Sekolah.</CardDescription>
          </CardHeader>
          <CardContent>
          <Table>
          <TableHeader>
